 ...
 *
 * This task does the following:
 *     1. Gets the source folder for JS customizer file
 *     2. Concatenates all the files and generates customizer.js
 *     3. Renames the JS file with suffix .min.js
 *     4. Uglifes/Minifies the JS file and generates customizer.min.js
 */
gulp.task( 'customizerJS', () => {
	return gulp
		...
		.pipe( lineec() ) // Consistent Line Endings for non UNIX systems.
		.pipe( gulp.dest( config.jsCustomizerDestination ) )
		.pipe(
			rename({
...
gulp.task(
	'default',
	gulp.parallel( 'styles', 'vendorsJS', 'customJS', 'customizerJS', 'images', browsersync, () => {
		gulp.watch( config.watchPhp, reload ); // Reload on PHP file changes.
		gulp.watch( config.watchStyles, gulp.parallel( 'styles' ) ); // Reload on SCSS file changes.
		gulp.watch( config.watchJsCustomizer, gulp.series( 'customizerJS' ) ); // Reload on customizerJS file changes.
